...
public class AdminSignupController {
	...
	*/
	...
	@GetMapping("getUserDetailes/{username}")
	public @ResponseBody UserDetailes findbyUsername(@PathVariable String username) {

		return adminSignupService.getUserByUsername(username);
