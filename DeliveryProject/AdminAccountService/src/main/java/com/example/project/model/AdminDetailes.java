...
public class AdminDetailes {
	...
	public AdminDetailes(int id, String adminName, String email, String password,
			java.util.List<AdminContact> contactList) {
		super();
		this.id = id;
		this.adminName = adminName;
		this.email = email;
	...
	public static java.util.List<AdminDetailes> getAllEmployees() {
		java.util.List<AdminContact> adminContacts = new ArrayList<AdminContact>();
		adminContacts.add(new AdminContact(1, "thy"));
		adminContacts.add(new AdminContact(2, "thghfy"));
		
		java.util.List<AdminDetailes> adminDetailesList = new ArrayList<AdminDetailes>();
		adminDetailesList.add(new AdminDetailes(1, "ruzaik", "ruzaikmohomad@gmail.com", "123", adminContacts));
		adminDetailesList.add(new AdminDetailes(1, "madush", "madush@gmail.com", "123", adminContacts));
